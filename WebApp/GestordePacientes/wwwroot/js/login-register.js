document.addEventListener('DOMContentLoaded', function () {
    ...
    function validarFormularioRegistro() {
        ...
        const nombredeususario = document.getElementsByName('NombreDeUsuario')[0];
        const consultorio = document.getElementsByName('Consultorio')[0];
        const correo = document.getElementsByName('Correo')[0];
        const contrasena = document.getElementsByName('Password')[0];
        const confirmarcontrasena = document.getElementsByName('ConfirmePassword')[0];
